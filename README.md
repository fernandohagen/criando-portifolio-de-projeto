<meta charset="UTF-8">
 ...
 <body>
     <header class="container text-center">
         <img src="img/avatar-perfil.png" alt="avatar da Fernando" class="rounded-circle" width="150" height="150"
             srcset="">
         <img src="img/avatar-perfil.png" alt="avatar da Fernando" class="rounded-circle" width="150" height="150" srcset="">
         <p class="lead">Eu sou Fernando_</p>
 ...
 @@ -27,192 +25,22 @@ <h1>Eu ensino Programação</h1>
     ...
     <footer class="container py-5">
         ...
         <p class="my-5 text-center">© Copyright 2024. Produzido por Fernando Mascheti</p>
     </footer>
    </footer>
